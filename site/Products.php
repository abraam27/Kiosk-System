...
<link rel="stylesheet" href="css/products-1.css" media="screen">
    ...
    <meta property="og:title" content="products 1">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-5a0a"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-palette-4-base u-section-1" id="carousel_757c">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-gallery u-hidden-md u-hidden-sm u-hidden-xs u-layout-grid u-lightbox u-no-transition u-show-text-on-hover u-gallery-1" id="carousel-7dbb">
        ...
        <div class="u-form u-form-1">
            <form action="confirmPay.php" method="POST" class="u-clearfix u-form-custom-backend u-form-horizontal u-form-spacing-0 u-inner-form" source="custom" name="form" style="padding: 14px;" redirect="true">
            
            
            <div class="u-form-group u-form-select u-label-left u-vertical-form-control-visible u-form-group-1">
              <label for="select-986a" class="u-label">10 ticket </label>
              <div class="u-form-select-wrapper">
                <select id="select-986a" name="EGP10" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            ...
            <div class="u-form-group u-form-select u-label-left u-vertical-form-control-visible u-form-group-2">
              <label for="select-f883" class="u-label">7 ticket</label>
              <div class="u-form-select-wrapper">
                <select id="select-f883" name="EGP7" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                  <option value="0">0</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
            ...
            <div class="u-form-group u-form-select u-label-left u-vertical-form-control-visible u-form-group-3">
              <label for="select-356e" class="u-label">5 ticket </label>
              <div class="u-form-select-wrapper">
                <select id="select-356e" name="EGP5" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                  <option value="0">0</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
            ...
            <div class="u-form-group u-form-submit u-label-left">
              ...
              <div class="u-align-left u-btn-submit-container">
                  <button type="submit" value="buy"  name="buy" class="u-btn u-btn-submit u-button-style u-btn-1">buy now</button>
              </div>
            </div>
        ...
        <div class="u-carousel u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-gallery u-gallery-slider u-hidden-lg u-hidden-xl u-layout-carousel u-lightbox u-no-transition u-show-text-none u-gallery-2" data-interval="5000" data-u-ride="carousel" id="carousel-6087">
